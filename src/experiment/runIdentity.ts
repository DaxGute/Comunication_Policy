  ...
  const evals = (run.multiAgentEvaluations ?? [])
    .map((evaluation) =>
      [
        ...
        evaluation.costUsd ?? "",
        evaluation.componentStatus.marble,
        evaluation.componentStatus.interaction ?? "",
        evaluation.componentStatus.belief,
        evaluation.componentStatus.moralDynamics ?? "",
        evaluation.marble ? "m" : "",
        evaluation.interaction ? "i" : "",
        evaluation.beliefDynamics ? "b" : "",
        evaluation.moralDynamics ? "d" : "",
